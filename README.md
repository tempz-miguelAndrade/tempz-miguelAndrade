...
**HTML**  
<div style="background:#555;border-radius:5px;">
  <div style="width:40%;background:#E34F26;padding:4px;border-radius:5px;"></div>
</div>

**CSS**  
<div style="background:#555;border-radius:5px;">
  <div style="width:30%;background:#1572B6;padding:4px;border-radius:5px;"></div>
</div>

**JavaScript**  
<div style="background:#555;border-radius:5px;">
  <div style="width:20%;background:#F7DF1E;padding:4px;border-radius:5px;"></div>
</div>

**Python**  
<div style="background:#555;border-radius:5px;">
  <div style="width:10%;background:#3776AB;padding:4px;border-radius:5px;"></div>
</div>
